...
SHMEM_INTERNAL_ENV_DEF(OFI_CXI_HYBRID_MR_DESC, bool, false, SHMEM_INTERNAL_ENV_CAT_TRANSPORT,
                       "Set to enable CXI hybrid local MR descriptor mode (skips internal MR registration when desc is non-NULL); ignored on non-CXI providers")
